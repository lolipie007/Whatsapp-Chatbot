...
class ScoreGet:
    def __init__(self):
        ...
        self.api_key = "d452590d-be0e-4ae6-8dc0-2a0b979da76d"
    ...
    def get_unique_id(self):
        ...
        for i in resp_dict['matches']:
            if (i['team-1'] == "Rajasthan Royals [RR]" or i['team-2'] == "India") and i['matchStarted']:
...
if __name__ == "__main__":
    ...
    account_sid = 'AC33bdeead9efcada598dbbe75195deddb'
    auth_token = '60a6012878647fcd9dc0c36a2439fcd1'
    client = Client(account_sid, auth_token)
    message = client.messages.create( body=send_message, from_='whatsapp:+14155238886', to='whatsapp:+91 8838205816' )